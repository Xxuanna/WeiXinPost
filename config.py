...
classes = \
    {
        ...
        "2": [
            ...
            ['中医内科学', '中医儿科学（理论）', '老年病学', '多喝水', '', ''],
            ['医学影像学', '西医内科学', '康复医学实训', '', '', ''],
            ['中医儿科学', '中医妇科学（理论）', '医学问道(某人说的)', '想揍李紫萱', '', ''],
            ['', '中药学', '这个点还睡就是懒猪起来喝水', '', '', ''],
            ['', '', '这个点还睡就是懒猪起来喝水', '', '', '']
        ],
        "3": [
